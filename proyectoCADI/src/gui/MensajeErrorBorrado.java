...
public class MensajeErrorBorrado extends javax.swing.JFrame {
    ...
    /**
     * Creates new form MensajeErrorBorrado
     */
    ...
    private void initComponents() {
        ...
        jLabelMensaje.setText("Su Actividad no ha podido ser Borrada");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MensajeErrorBorrado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MensajeErrorBorrado().setVisible(true);
            }
        });
    }
