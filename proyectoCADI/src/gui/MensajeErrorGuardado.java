 ...
 */
public class MensajeErrorGuardado extends javax.swing.JFrame {

    /**
     * Creates new form MensajeError
     */
    public MensajeErrorGuardado() {
        initComponents();
        setVisible(true);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MensajeErrorGuardado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MensajeErrorGuardado().setVisible(true);
            }
        });
    }
