 ...
 */
public class MensajeValidacion extends javax.swing.JFrame {

    /**
     * Creates new form MensajeValidacion
     */
    ...
    private void initComponents() {
        ...
        jLabelMensaje.setText("Algunos Campos estan vacios, verifique porfavor");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MensajeValidacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MensajeValidacion().setVisible(true);
            }
        });
    }
